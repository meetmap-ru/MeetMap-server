...
class UserRepositoryImpl(
    ...
    override fun signUp(user: User, password: String): State<User> {
    ...
    override fun signIn(login: String, password: String): State<User> {
    ...
    override fun deleteAccount(id: Long, password: String): State<Unit> {
    ...
    override fun getById(id: Long, private: Boolean): State<User> {
        val user = userDao.findById(id).getOrNull() ?: throw NotFoundException()
        return State.Success(user.asDomain().apply {
    ...
    override fun getByIds(vararg ids: Long): State<List<User>> {
        val userList: List<User> = ids.asList().mapNotNull { id ->
    ...
    override fun setPassword(id: Long, oldPassword: String, password: String): State<Unit> {
        val user = userDao.findById(id).getOrNull() ?: throw NotFoundException()
    ...
    override fun setDescription(id: Long, description: String): State<Unit> {
        val user = userDao.findById(id).getOrNull() ?: throw NotFoundException()
